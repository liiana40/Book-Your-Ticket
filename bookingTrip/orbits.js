 ...
 */
 ...
 function selectDate(event) {
	 ...
	 if (callerElement.innerHTML === "") {
		 // cell contains no date, so don't closr the calendar
		 document.getElementById("cal").style.display = "block";
		 return false;
	 }
...
function updateCountdown() {
	...
	var dateTo = Date.UTC(dateObject.getFullYear(),dateObject.getMonth(),dateObject.getDate(), 19, 0, 0);//all launches at 8:00 UTC	
